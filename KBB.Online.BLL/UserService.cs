...
namespace KBB.Online.BLL
{
    public class UserService
    {
        ...
        public object IIN { get; private set; }

        //Метод для создания юзера в бд
        ...
        public bool GetUserData (string Iin, out string message)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("При запросе данных возникла ошибка" +
                ...
                {
                    throw new Exception("По введеному ИИН данных нет");
                }
